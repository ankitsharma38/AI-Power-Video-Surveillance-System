...
def main(video_path=None):
    ...
    if video_path and os.path.exists(video_path):
        ...
        logging.info("No video file provided or file not found. Using webcam.")
        cap = cv2.VideoCapture(0)

    if not cap.isOpened():
        logging.error("Video source not accessible.")
...
if __name__ == "__main__":
    video_path = "data/input/mee.mp4"  # Path to input video
    main(video_path)
